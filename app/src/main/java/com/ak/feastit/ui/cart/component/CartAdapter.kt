...
internal class CartAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    COMPONENT_RECIPE -> {
      val binding = ComponentCartHeadingRecipeBinding.inflate(
    ...
    COMPONENT_AISLE -> {
      val binding =
        ComponentCartHeadingAisleBinding.inflate(LayoutInflater.from(parent.context), parent, false)
      ComponentCartAisle(binding)
    }

    COMPONENT_INGREDIENT -> {
      val binding =
        ComponentCartIngredientBinding.inflate(LayoutInflater.from(parent.context), parent, false)
