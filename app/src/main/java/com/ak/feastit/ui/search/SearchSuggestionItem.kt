...
sealed interface SearchSuggestionItem {
    ...
    data class Header(val name: String) : SearchSuggestionItem {
        override fun areItemsSame(other: SearchSuggestionItem): Boolean {
            return other is Header && other == this
        }
    ...
    data class History(val result: String) : SearchSuggestionItem {
        override fun areItemsSame(other: SearchSuggestionItem): Boolean {
            return other is History && other == this
        }
    ...
    data class Recommendation(val recipe: Recipe) : SearchSuggestionItem {
        override fun areItemsSame(other: SearchSuggestionItem): Boolean {
            return other is Recommendation && other == this
        }
