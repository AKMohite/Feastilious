...
package com.ak.feastit.compose.data.utils
...
internal data class FilterPreferences(
  val isFirstInstall: Boolean,
  val recentSearches: List<String>,
)

@Singleton
internal class FeastPrefManager
@Inject
constructor(
  ...
  suspend fun addRecentSearches(searchQuery: String) = withContext(dispatcher.io) {
    ...
    context.dataStore.edit { preferences ->
      var recentSearches =
        (preferences[PreferencesKeys.SEARCH_QUERY] ?: "").split(',').toSet().toMutableList()
